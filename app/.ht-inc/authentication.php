...
/// This function edited by Graham
///	All lines are original unless appended with //&& (these were added by Graham)
///
/// Function calls are referencing /themes/newdropdownmenus/firstPage.php
...
function selectAuth() {
	...
	// require_once("themes/$skin/firstPage.php");						//&&
	...
	print "<div class=\"container-fluid\" id=\"loginlayout\">\n";							//&&
	print "<div class=\"row equal\">\n";																			//&&
	print "<div class=\"col-md-7\" id=\"loginform\">\n";											//&&
	print i("<div id=\"select-instruct\">Please select an authentication method:</div>") . "<br><br>\n";
	...
	print "<INPUT type=hidden name=mode value=selectauth>\n";
	...
	print "<INPUT class=\"btn btn-default col-xs-12\" type=submit value=\"" . i("Proceed to Login") . "\" tabindex=3 name=userid>\n";
	print "</FORM>\n";
	print "</div> <!-- row -->\n";																						//&&
	print "</div>\n"; # loginform

	print "<div class=\"col-md-5\" id=\"loginhelp\">\n";
	print "		<div id=\"help-message\">" . i("Explanation of authentication methods:") . "</div>\n";
	print "<hr />\n";																					//&&
