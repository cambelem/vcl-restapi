...
///
////////////////////////////////////////////////////////////////////////////////
function processRequestInput($data = NULL) {
	global $user;
	...
	*/
	...
	# type
	$return['type'] = $data['type'];//processInputVar('type', ARG_STRING);
	...
	# nousercheck
	$return['nousercheck'] = $data['nousercheck'];
