...
function timeSourceHTML($globalopts) {
	...
	$h = "<div class=\"row card-padding\">";
	$h .= "<div class=\"col-md-12\">";
	$h .= "<div class=\"mdc-card time-source-card card\">";
	$h .= "<section class=\"mdc-card__primary card-header\" data-background-color=\"ibmBlue\">";
	//$h .= "<h1 class=\"mdc-card__title mdc-card__title--large\">Title goes here</h1>";

	$h .= "<h1 class=\"mdc-card__title mdc-card__title--large\">Time Source</h1>";
	$h .= "</section>";
...
class TimeVariable {
	...
	function getHTML($globalopts) {
		...
		$h .= "<h1 class=\"mdc-card__title mdc-card__title--large\">{$this->name}</h1>";
		$h .= "</section>";
		...
		$h .= "</div>"; //card-content closing div
		$h .= "</div>"; //col closing div
		$h .= "</div>"; // row closing div
		$h .= "</div>\n";
		return $h;
	}
...
class AffilTextVariable {
	...
	///
	/// FOURTH AND ON ON SITE CONFIG LEFT COL
	/////////////////////////////////////////////////////////////////////////////
	function getHTML($globalopts) {
		global $user;
		//$h  = "<div class=\"configwidget\" style=\"width: 100%;\">\n";
