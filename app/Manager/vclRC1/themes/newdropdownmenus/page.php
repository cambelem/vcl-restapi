...
function getHeader($refresh) {
	...
	$rt .= "<link rel=\"stylesheet\"
								href=\"/vcl/themes/newdropdownmenus/node_modules/material-components-web/dist/material-components-web.css\" />\n";
	...
	//$rt .= "<script src=\"/vcl/themes/newdropdownmenus/node_modules/jquery/dist/jquery.min.js\"></script>\n";

	$rt .= "<link href=\"themes/newdropdownmenus/css/theme.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
	$rt .= "<link href=\"themes/newdropdownmenus/css/app.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
	/*$rt .= "<script src=\"themes/newdropdownmenus/js/topnav.js\" type=\"text/javascript\"></script>\n";*/
...
//$rt .= "<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js\"></script>\n";
	...
	$rt .= "<script src=\"themes/newdropdownmenus/js/updatedNavBar.js\" type=\"text/javascript\"></script>\n";

	$rt .= "</head>\n";

	$rt .= "<body class=\"newdropdownmenus\">\n";
	...
	$rt .= "  <div class=\"container\" id=\"title\">\n";
	$rt .= "    <img src=\"themes/newdropdownmenus/images/vcllogo.png\" class=\"header-logo\" />\n";
	$rt .= "    <h1 class=\"site-title\">\n";
	$rt .= "      <span>" . i('Academic Cloud') . "</span><br />\n";
	$rt .= "    </h1>\n";
	$rt .= "  </div><!-- .container -->\n";
	...
	$rt .= "<div id=\"contentParent\" class=\"responsive-columns-wrapper\">\n";
	$rt .=   "<div class=\"chat-column\">\n";

	$rt .=       "<div id=\"openchat\">\n";
	$rt .=					"<span id=\"chatIcon\" style=\"font-size:1.5em;\" class=\"glyphicon glyphicon-comment\" aria-hidden=\"true\"></span>";
	$rt .=       "</div>\n";
	$rt .=   "</div>\n"; # chat-column
	$rt .=   "<div id=\"payload-column\" class=\"fixed-column content-column\">\n";
	$rt .=     "<div id=\"payload-initial-message\">\n";
	$rt .=       "Type something to see the output";
	$rt .=     " </div>\n";
	$rt .=     "<div id=\"payload-request\" class=\"payload\">\n";
	$rt .=     "</div>\n";

	$rt .=     "<div id=\"payload-response\" class=\"payload\">\n";
	$rt .=     "</div>\n";
	$rt .=   "</div>\n"; # payload-column

	$rt .= "</div>\n"; #contentParent

	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/chatbot.js\" type=\"text/javascript\"></script>\n";
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/common.js\"></script>\n";
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/api.js\"></script>\n";
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/conversation.js\"></script>\n";
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/payload.js\"></script>\n";
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/js/global.js\"></script>\n";

	$rt .= "<div id=\"textInputDummy\"></div>\n";
	...
	$rt .=     "<div id=\"chatWrapper\">\n";
	$rt .= 		 "<button id=\"closeChatbot\" type=\"button\" class=\"close\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>";
	$rt .=       "<div id=\"scrollingChat\">\n";
	$rt .=       "</div>\n";
	$rt .=       "<label for=\"textInput\" class=\"inputOutline\">\n";
	$rt .=         "<input id=\"textInput\" class=\"input responsive-column\"
...
function getFooter() {
	...
	$rt .= "<img src=\"themes/newdropdownmenus/images/feather_tiny.png\">\n";
	...
	$rt .= "<script src=\"/vcl/themes/newdropdownmenus/node_modules/material-components-web/dist/material-components-web.js\"></script>\n";
	$rt .= "<script>mdc.autoInit()</script>\n";
